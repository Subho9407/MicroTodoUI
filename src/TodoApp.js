...
const GET_TASKS_API_BASE_URL = 'http://get-task.subhojitgoswami.cloud';
const DELETE_TASK_API_BASE_URL = 'http://delete-task.subhojitgoswami.cloud';
const CREATE_TASK_API_BASE_URL = 'http://add-task.subhojitgoswami.cloud';
